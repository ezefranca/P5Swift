...
The independent p5.swift repository has no remaining implementation work for its current pre-1.0 scope. Exhaustive *Nature of Code* example ports are explicitly excluded.

## Local definition of done

- [x] Single `P5` library product with no production package dependency.
...
- [ ] Merge the release-candidate branch to `main` in the public repository.
